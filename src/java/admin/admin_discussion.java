...
public class admin_discussion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (int i = 0; i < distitle.length; i++) {
                q = "insert into details_master(discussion_title, discussion_details, discussion_postedby) VALUES ('" + distitle[i] + "','" + disdetail[i] + "','admin')";
                statement.execute(q);
            }
