                ...
                <div id="page">
                    <div id="content">
                        <div class="post">
                            <h2 class="title">&nbsp;</h2>
                            <div class="entry">
                                <form action="user_addmaterial.jsp" method="post" name="upForm" enctype="multipart/form-data">
                                                ...
                                                if (MultipartFormDataRequest.isMultipartFormData(request)) {
                                                    ...
                                                    if ((todo != null) && (todo.equalsIgnoreCase("upload"))) {
                                                        ...
                                                        if ((files != null) && (!files.isEmpty())  ) {
                                                            ...
                                                            if (file != null && file.getFileSize() < 5242880 && (file.getContentType().compareTo("text/html")==0 || file.getContentType().compareTo("application/msword")==0 || file.getContentType().compareTo("application/vnd.openxmlformats-officedocument.wordprocessingml.document")==0 || file.getContentType().compareTo("application/vnd.ms-powerpoint")==0 || file.getContentType().compareTo("application/vnd.openxmlformats-officedocument.presentationml.presentation")==0 || file.getContentType().compareTo("application/pdf")==0 || file.getContentType().compareTo("text/plain")==0 )  ) {
                                                                out.println("<li>Form fields : uploadfile" + "<BR> Uploaded file : " + file.getFileName() + " (" + file.getFileSize()/1024 + " KB)" + "<BR> Content Type : " + file.getContentType());
                                                            } else {
                                                                out.print("File size must be less than 5 mb and must be of document format");
                                                            }
                                                        ...
                                                        try {
                                                          ...
                                                          String  postedby1 = rsu.getString(2) + " " + rsu.getString(3);
                                                            ...
                                                            String q = "INSERT INTO material_master (mat_title,mat_file,mat_postby,subject_id) VALUES('" + mat_title + "','" + file.getFileName() + "','" + postedby1 + "','" + subject_id + "')";
                                                            // out.print(q);
