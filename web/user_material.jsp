        ...
        <div id="wrapper">
            <div id="wrapper2">
                ...
                <div id="page">
                    <div id="content">
                        <div class="post">
                                <h2 class="title"><a href="#"> Materials </a></h2>
                            <div class="entry">
                              <form method="post">
                                  <h3 align="center">Study Material-Learning Zone</h3><br/>
                                  `
<h3><b>Estrad's Blackboard's </b>Study Material is accompanied with PDF,Powerpoint Presentation ,Word Documents and illustrations that explain concepts in simple and easy manner.With the multimedia-enriched study material you have flexibility to go through the material anytime and most importantly as many times as you need to,so as to completely understand the topic. </h3>

                                  <p align="left"><a href="user_addmaterial.jsp">Add new Material</a> </p> 
                    <%
                        try {
                    ...
                    %>
                    <table width="100%" border="0" cellspacing="2" cellpadding="7" style="border:solid;">
                        <tr>
                            <td colspan="3"><b>Search Material</b> </td>
                        </tr>
                        <tr>
                ...
                <table width="100%" border="1" cellspacing="2" cellpadding="4" style="border: solid;">
                    <%                                    String drpcategory = request.getParameter("drpcategory");
                            ResultSet rs = statement.executeQuery("select * from material_master where subject_id = " + drpcategory);
                            int cnt=0;
                            while (rs.next()) {
                                cnt++;
                                out.print("<tr><td colspan='2'>");
                                out.print(rs.getString(2));
                                out.print("<td rowspan='2' valign='bottom'><a href='/mat/" + rs.getString("mat_file") + "'> View </a>");
                                out.print("<tr><td>Posted By :");
                                out.print(rs.getString(4));
                                out.print("<td>Dated at :" + rs.getString(5));
                            }
                              out.print("<tr><td colspan='3'> Total Materials (" + cnt + ")");
