...
<div id="wrapper">
	<div id="wrapper2">
                    ...
                    if ((files != null) && (!files.isEmpty())) {
                        ...
                        try {
                            ...
                            String subject_id = mrequest.getParameter("drpcategory");
                              ...
                              String q = "INSERT INTO video_master (vid_title,vid_file,vid_postedby,subject_id) VALUES('" + vid_title + "','" + file.getFileName() + "','admin','"+ subject_id + "')";
                           // out.print(q);
        ...
        <form action="admin_addvideo.jsp" method="post" name="upForm" enctype="multipart/form-data">
            <h3>Videos</h3><input type="hidden" name="todo" value="upload">
